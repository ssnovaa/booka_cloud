...
class User extends Authenticatable
{
    ...
    // ᐊ===============================================================
    //    ✅✅✅ ДИНАМІЧНА ПЕРЕВІРКА ПІДПИСКИ ✅✅✅
    // ᐊ===============================================================
    /**
     * Аксесор для поля is_paid.
     * Якщо термін paid_until минув, автоматично повертає false.
     */
    public function getIsPaidAttribute($value): bool
    {
        // Якщо дата закінчення встановлена і вона вже в минулому (менше ніж зараз)
