...
<div class="max-w-7xl mx-auto px-4 lg:px-8 py-6">
    ...
    @if($listened->count())
        ...
        <div class="mt-6">{{ $listened->links() }}</div>
    @else
        <div class="text-gray-500">Поки що порожньо.</div>
    @endif
</div>

<script>
// тот же обработчик кликов
